...
const dict = {
  ...
  "markets.disclaimer": {
    en: "Peer-to-peer staking settled in nTZS — you stake against other users, not a bookmaker. 18+. Stake responsibly.",
    sw: "Dau la mtu kwa mtu hulipwa kwa nTZS — unaweka dau dhidi ya watumiaji wengine, si kampuni. Miaka 18+. Weka dau kwa busara.",
  },
